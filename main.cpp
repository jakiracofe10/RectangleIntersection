...
bool doRectanglesIntersect(rectangle r1, rectangle r2) {
    ...
    if (!(r1.botLeft.x > r2.topRight.x || r1.topRight.x < r2.botLeft.x)) {
        return true;
    } else if (!(r1.botLeft.y > r2.topRight.y || r1.topRight.y < r2.botLeft.y)) {
        return true;
    } else if (r1.botLeft.x > r2.botLeft.x && r1.topRight.x < r2.topRight.x) {
        return true;
    } else if (r1.botLeft.y > r2.botLeft.y && r1.topRight.y < r2.topRight.y) {
        return true;
    }
    return false;
}
